 const regex = /getStyleObjectFromString\(\s*"(.*)"\s*\)/gm;

// Alternative syntax using RegExp constructor
// const regex = new RegExp('getStyleObjectFromString\\((\\s*".*"\\s*)\\)', 'gm')

const str = `import { getStyleObjectFromString } from "@/utils/stringUtils";
...
export const InstagramViewer = (props : InstagramViewerProps) => {
    ...
    return (
        <div className="flex flex-row justify-center">
            ...
            >
                <div style={getStyleObjectFromString("padding:16px;")}>
                    {" "}
                    <a
                        href={url}
                        style={getStyleObjectFromString(
                    ...
                    >
                        ...
                        <div style={getStyleObjectFromString("padding: 19% 0;")}></div>{" "}
                        <div
                            style={getStyleObjectFromString(
                        ...
                        <div style={getStyleObjectFromString("padding-top: 8px;")}>
                            {" "}
                            <div
                                style={getStyleObjectFromString(
                        ...
                        <div style={getStyleObjectFromString("padding: 12.5% 0;")}></div>{" "}
                        <div
                            style={getStyleObjectFromString(
                        ...
                        >
                            ...
                            <div style={getStyleObjectFromString("margin-left: 8px;")}>
                                {" "}
                                <div
                                    style={getStyleObjectFromString(
                            ...
                            <div style={getStyleObjectFromString("margin-left: auto;")}>
                                {" "}
                                <div
                                    style={getStyleObjectFromString(
                    ...
                    >
                        <a
                            ...
                            target="_blank"
                        >
                            A post shared by Demiya (@demiya_inc)
                        </a>
                    </p>
                </div>
            </blockquote>{" "}
...
while ((m = regex.exec(str)) !== null) {
    ...
    newStr = newStr.replace(m[0], JSON.stringify(getStyleObjectFromString(m[1].trim())));
}
